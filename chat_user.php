...
<body class="chats-tab-open">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<ul class="nav flex-nowrap">
										<li class="nav-item list-inline-item mr-1">
											<a href="#" class="btn btn-outline-secondary" id="logout_button">Logout</a>
										</li>
										<li class="nav-item list-inline-item mr-1">
			...
			<div class="chats">
				<div class="chat-body">
					...
					<div class="chat-header">
						...
						<a href="./chat.php" class="btn btn-secondary btn-icon btn-minimal btn-sm text-muted" type="button" data-close="">
							<!-- Default :: Inline SVG -->
							<svg class="hw-20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
							...
							<!-- Alternate :: External File link -->
							<!-- <img class="injectable hw-20" src="./assets/img/heroicons/outline/arrow-left.svg" alt=""> -->
						</a>

						<!-- Chat participant's Name -->
						<div class="media chat-name align-items-center text-truncate">
							<div class="avatar avatar-online d-none d-sm-inline-block mr-3">
								<img src="./assets/storage/<?php echo ($row['img']); ?>" alt="" />
							</div>
						...
						<ul class="nav flex-nowrap">
							<li class="nav-item list-inline-item d-none d-sm-block mr-1">
								<a class="nav-link text-muted px-1" data-toggle="collapse" data-target="#searchCollapse" href="#" aria-expanded="false">
									...
									<!-- Alternate :: External File link -->
									<!-- <img src="./assets/img/heroicons/outline/search.svg" alt="" class="injectable hw-20"> -->
								</a>
							</li>
							...
							<li class="nav-item list-inline-item d-none d-sm-block mr-1">
								<a class="nav-link text-muted px-1" href="#" title="Add People">
									...
									<!-- Alternate :: External File link -->
									<!-- <img src="./assets/img/heroicons/outline/phone.svg" alt="" class="injectable hw-20"> -->
								</a>
							</li>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item align-items-center d-flex" href="#" data-chat-info-toggle="">
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/information-circle.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>View Info</span>
										</a>
										...
										<a class="dropdown-item align-items-center d-flex" href="#">
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/volume-off.svg" alt="" class="injectable hw-20 mr-2"> -->
										...
										<a class="dropdown-item align-items-center d-flex" href="#">
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/photograph.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>Wallpaper</span>
										</a>
										<a class="dropdown-item align-items-center d-flex" href="#">
											<!-- Default :: Inline SVG -->
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/archive.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>Archive</span>
										</a>
										<a class="dropdown-item align-items-center d-flex" href="#">
											<!-- Default :: Inline SVG -->
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/trash.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>Delete</span>
										</a>
										<a class="dropdown-item align-items-center d-flex text-danger" href="#">
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/ban.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>Block</span>
										</a>
									</div>
								</div>
								...
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item align-items-center d-flex" href="#">
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/phone.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>Call</span>
										</a>
										<a class="dropdown-item align-items-center d-flex" href="#" data-toggle="collapse" data-target="#searchCollapse" aria-expanded="false">
											...
											<!-- Alternate :: External File link -->
											<!-- <img src="./assets/img/heroicons/outline/search.svg" alt="" class="injectable hw-20 mr-2"> -->
											<span>Search</span>
										</a>
							...
							<div class="input-group bg-light">
								...
								<div class="input-group-append">
									<span class="input-group-text transparent-bg border-left-0">
										...
										<!-- Alternate :: External File link -->
										<!-- <img class="injectable hw-20" src="./assets/img/heroicons/outline/search.svg" alt="Search icon"> -->
									</span>
								</div>
							</div>
						</div>
					...
					<div class="chat-content p-2" id="messageBody">
						<div class="container" id="msg_container">
							...
							<!-- <div class="message-day">
								<div class="message-divider sticky-top pb-2" data-label="Yesterday">
									&nbsp;
								</div> -->
							...
							<!-- Message Day Start -->
							<!-- <div class="message-day">
								<div class="message-divider sticky-top pb-2" data-label="Today">
									&nbsp;
								</div> -->
							<!-- </div> -->
							<!-- Message Day End -->
					...
					<!-- Chat Footer Start-->
					<div class="chat-footer d-flex justify-content-center w-100">

						<form action="#" class="form w-75 d-flex align-items-center justify-content-between" id="chat_form" method="POST" rows="1">
							<div class="attachment">
								<div class="dropdown">
									<button class="btn btn-secondary btn-icon btn-minimal btn-sm" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										...
										<!-- <img class="injectable hw-20" src="./assets/img/heroicons/outline/plus-circle.svg" alt=""> -->
									</button>
									<div class="dropdown-menu">
										<a class="dropdown-item" href="#">
											...
											<!-- <img class="injectable hw-20 mr-2" src="./assets/img/heroicons/outline/photograph.svg" alt=""> -->
											<span>Gallery</span>
										</a>
										<a class="dropdown-item" href="#">
											<svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											...
											<!-- <img class="injectable hw-20 mr-2" src="./assets/img/heroicons/outline/volume-up.svg" alt=""> -->
											<span>Audio</span>
										</a>
										<a class="dropdown-item" href="#">
											<svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											...
											<!-- <img class="injectable hw-20 mr-2" src="./assets/img/heroicons/outline/document.svg" alt=""> -->
											<span>Document</span>
										</a>
										<a class="dropdown-item" href="#">
											<svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											...
											<!-- <img class="injectable hw-20 mr-2" src="./assets/img/heroicons/outline/user.svg" alt=""> -->
											<span>Contact</span>
										</a>
										<a class="dropdown-item" href="#">
											<svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											...
											<!-- <img class="injectable hw-20 mr-2" src="./assets/img/heroicons/outline/location-marker.svg" alt=""> -->
											<span>Location</span>
										</a>
										<a class="dropdown-item" href="#">
											<svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											...
											<!-- <img class="injectable hw-20 mr-2" src="./assets/img/heroicons/outline/chart-square-bar.svg" alt=""> -->
											<span>Poll</span>
										</a>
									</div>
								</div>
							...
							<input type="text" name="incoming_id" value="<?php echo $unique_id; ?>" hidden>
							<textarea class="form-control emojionearea-form-control" id="messageInput" name="msg" placeholder="Type your message here..."></textarea>
							<button type="submit" name="submit" class="btn btn-primary btn-icon send-icon rounded text-light" id="msg_btn" role="button"><i class="fa-solid fa-paper-plane"></i></button>
						</form>
					</div>
					<!-- Chat Footer End-->
				</div>
								...
								<ul class="nav justify-content-between align-items-center">
									...
									<li class="nav-item list-inline-item">
										<a class="nav-link text-muted px-0" href="#" data-chat-info-close="">
											...
											<!-- Alternate :: External File link -->
											<!-- <img class="injectable hw-22" src="./assets/img/heroicons/outline/x.svg" alt=""> -->
										</a>
									</li>
									<!-- Close Sidebar End -->
								</ul>
						...
						<div class="hide-scrollbar flex-fill">
							...
							<div class="text-center p-3">
								...
								<p class="text-muted d-flex align-items-center justify-content-center">
									...
									<!-- Alternate :: External File link -->
									<!-- <img class="injectable mr-1 hw-18" src="./assets/img/heroicons/outline/location-marker.svg" alt=""> -->
								...
								<div class="d-flex align-items-center justify-content-center">
									<div class="btn btn-outline-default btn-icon rounded-circle mx-1">
										...
										<!-- Alternate :: External File link -->
										<!-- <img class="injectable hw-20" src="./assets/img/heroicons/outline/user-add.svg" alt=""> -->
									</div>
									<div class="btn btn-primary btn-icon rounded-circle text-light mx-1">
										...
										<!-- Alternate :: External File link -->
										<!-- <img class="injectable hw-20" src="./assets/img/heroicons/outline/heart.svg" alt=""> -->
									</div>
									<div class="btn btn-danger btn-icon rounded-circle text-light mx-1">
										...
										<!-- Alternate :: External File link -->
										<!-- <img class="injectable hw-20" src="./assets/img/heroicons/outline/ban.svg" alt=""> -->
									</div>
								</div>
							</div>
							<!-- User Profile End -->
							...
							<div class="chat-info-group">
								<a class="chat-info-group-header" data-toggle="collapse" href="#profile-info" role="button" aria-expanded="true" aria-controls="profile-info">
									...
									<!-- Alternate :: External File link -->
									<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/information-circle.svg" alt=""> -->
								</a>
							...
							<div class="chat-info-group">
								<a class="chat-info-group-header" data-toggle="collapse" href="#shared-media" role="button" aria-expanded="true" aria-controls="shared-media">
									...
									<!-- Alternate :: External File link -->
									<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/photograph.svg" alt=""> -->
								</a>
									...
									<div class="chat-info-group-content">
										...
										<div class="form-row">
											<div class="col-4 col-md-2 col-xl-4">
												<a href="#">
													<img src="./assets/img/shared-photos/01.jpg" class="img-fluid rounded border" alt="" />
												</a>
											</div>
											<div class="col-4 col-md-2 col-xl-4">
												<a href="#">
													<img src="./assets/img/shared-photos/02.jpg" class="img-fluid rounded border" alt="" />
												</a>
											</div>
											<div class="col-4 col-md-2 col-xl-4">
												<a href="#">
													<img src="./assets/img/shared-photos/03.jpg" class="img-fluid rounded border" alt="" />
												</a>
											</div>
										</div>
									</div>
							...
							<div class="chat-info-group">
								<a class="chat-info-group-header" data-toggle="collapse" href="#shared-files" role="button" aria-expanded="true" aria-controls="shared-files">
									...
									<!-- Alternate :: External File link -->
									<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/document.svg" alt=""> -->
								</a>
											...
											<li class="list-group-item">
												<div class="document">
													<div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
														...
														<!-- Alternate :: External File link -->
														<!-- <img class="injectable hw-24" src="./assets/img/heroicons/outline/document.svg" alt=""> -->
													</div>
											...
											<li class="list-group-item">
												<div class="document">
													<div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
														...
														<!-- Alternate :: External File link -->
														<!-- <img class="injectable hw-24" src="./assets/img/icons/excel-file.svg" alt=""> -->
													</div>
											...
											<li class="list-group-item">
												<div class="document">
													<div class="btn btn-primary btn-icon rounded-circle text-light mr-2">
														...
														<!-- Alternate :: External File link -->
														<!-- <img class="injectable hw-24" src="./assets/img/icons/powerpoint-file.svg" alt=""> -->
													</div>

													<div class="document-body">
														<h6 class="text-truncate">
															<a href="#" class="text-reset" title="great-presentation-on global-warming-2020.ppt">Great-presentation-on
									...
									<div class="media">
										<div class="avatar avatar-primary mr-2">
											<span>
												...
												<!-- <img class="injectable hw-24" src="./assets/img/heroicons/solid/phone-incoming.svg" alt=""> -->
											</span>
										</div>
									...
									<div class="media">
										<div class="avatar avatar-primary mr-2">
											<span>
												...
												<!-- <img class="injectable hw-24" src="./assets/img/heroicons/solid/phone-outgoing.svg" alt=""> -->
											</span>
										</div>
								...
								<div class="card-body">
									<div class="media">
										...
										<div class="media-body">
											...
											<div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
												<p class="text-muted mb-0">Yesterday at 10:45PM</p>
												<span class="d-none d-sm-block text-muted mx-2">•</span>
								...
								<div class="card-body">
									<div class="media">
										...
										<div class="media-body">
											...
											<div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
												<p class="text-muted mb-0">16/05/2020 at 11:49AM</p>
												<span class="d-none d-sm-block text-muted mx-2">•</span>
								...
								<div class="card-body">
									<div class="media">
										...
										<div class="media-body">
											...
											<div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
												<p class="text-muted mb-0">14/05/2020 at 11:49AM</p>
												<span class="d-none d-sm-block text-muted mx-2">•</span>
									...
									<div class="d-flex flex-column align-items-center">
										...
										<div class="d-flex mt-2">
											<div class="btn btn-primary btn-icon rounded-circle text-light mx-2">
												...
												<!-- <img class="injectable hw-24" src="./assets/img/heroicons/outline/chat.svg" alt=""> -->
											</div>
											<div class="btn btn-success btn-icon rounded-circle text-light mx-2">
												...
												<!-- <img class="injectable hw-24" src="./assets/img/heroicons/outline/phone.svg" alt=""> -->
											</div>
										</div>
									</div>
								</div>
								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/clock.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/calendar.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/phone.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/mail.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/globe.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/heroicons/outline/home.svg" alt=""> -->
										</div>
									</li>
								</ul>
							</div>
								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/icons/facebook.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/icons/twitter.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/icons/instagram.svg" alt=""> -->
										</div>
									</li>
									<li class="list-group-item">
										<div class="media align-items-center">
											...
											<!-- <img class="injectable text-muted hw-20" src="./assets/img/icons/linkedin.svg" alt=""> -->
										</div>
									</li>
								</ul>
							</div>
						...
						<div class="col">
							<div class="card mb-3">
								...
								<div class="card-footer d-flex justify-content-end">
									<button type="button" class="btn btn-link text-muted mx-1">
										Reset
									</button>
	...
	<script src="./assets/js/singleChat.js"></script>
